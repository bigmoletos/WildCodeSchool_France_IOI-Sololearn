...
def testGrapheList():
    ...
    for loop in range( nombrePairesZones ):
        ...
        # list = [1, -1, -19, -3, -13, -10, -8, -7, -6]
        # list = [1, -12, -19, -13, -19, -7, -13, -16, -1]
        # list=[1, -15, -16, -13, -8, -1, -16, -16, -8]
        # list=[1, -9, -12, -1, -19, -4, -18, -19, -13]
        # list=[1, 10, 17, 0, 25, 15, 3, 20, 18]
        # list=[1, -9, -4, -2, -13, -12, -7, -12, -17]
        list=[1, 20, 22, 20, -11, 20, -16, 22, -1]
        # list=[1, -17, 8, 22, 3, 4, 19, -2, 3]
        # list=[1, 12, 25, -7, 13, -15, 21, 4, 11]
